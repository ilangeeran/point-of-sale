        ...
        <div class="row check_group">
          ...
          <div class="col-md-9">
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'banner.view', in_array('banner.view', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.banner.view' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'banner.create', in_array('banner.create', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.banner.create' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'banner.update', in_array('banner.update', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.banner.update' ) }}
                </label>
              </div>
            </div>
            <div class="col-md-12">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('permissions[]', 'banner.delete', in_array('banner.delete', $role_permissions), 
                  [ 'class' => 'input-icheck']); !!} {{ __( 'role.banner.delete' ) }}
                </label>
              </div>
            </div>
          </div>
